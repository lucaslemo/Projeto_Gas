                  ...
                  <div class="card recent-sales overflow-auto">
                    ...
                    <div class="card-body">
                      ...
                      <table class="table table-borderless datatable">
                        ...
                        <tbody>
                          @foreach($tabelaVendas as $index => $venda)
                          <tr>
                            <th scope="row">{{ $venda->cliente }}</th>
                            <td>{{ date('d/m/Y', strtotime($venda->data_da_venda)) }}</td>
                            <td class="text-primary">R$ {{ $venda->valor_total }}</td>
                            <td>{{ ucfirst($venda->tipo_pagamento) }}</td>
                            <td>
                              <div class="d-flex">
                                @if(is_null($venda->data_do_pagamento))
                                <span class="badge bg-warning me-1">Aguardando Pagamento</span>
                                @else
                                <span class="badge bg-success me-1">Paga</span>
                                @endif
                                @if(!is_null($venda->entregador))
